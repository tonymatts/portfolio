/*MODIFIED BY ADDING CUSTOMIZED "startActivity" on line 31 for Murder in the Commons
 * PanoramaGL library
 * Version 0.2 beta
...
public class PLCommandTokenizer extends PLTokenizer
{
	...
	protected void initializeValues()
	{
		...
		this.addToken(PLTokenType.PLTokenTypeFunction, "startActivity|load|BLEND|lookAtAndZoom|lookAt|zoom|fov|null");
